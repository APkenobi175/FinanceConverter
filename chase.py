...
# Converts CSV generated by Chase Bank into a standard file format that I use to apply to my finances spreadsheet

def convertChaseToStandardFile(inputFile):
    print("Converting...")

    # Get the directory and base filename of the input file
    directory = os.path.dirname(inputFile)
    base_filename = os.path.splitext(os.path.basename(inputFile))[0]
...
if __name__ == "__main__":
    ...
    convertChaseToStandardFile(inputFile)
